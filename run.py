...
if __name__ == "__main__":
    ...
    for N, THREADS in zip([4, 8, 16, 32, 64, 128, 256, 512, 1024], [4, 8, 16, 32, 64, 128, 256, 512, 512]):
        ...
        fname = f"figs_jacobi_dist/3_result_{config.N}_{config.THRESHOLD}_{config.sensor.VARIANCE[0]:.2f}-{config.sensor.VARIANCE[1]:.4f}_{config.CONTROL_VARIANCE[0]:.4f}-{config.CONTROL_VARIANCE[1]:.2f}.json"
